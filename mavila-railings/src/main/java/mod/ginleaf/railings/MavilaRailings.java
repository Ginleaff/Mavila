...
public class MavilaRailings implements ModInitializer {
	...
	public static final RailingBlock WHITE_RAILING_BLOCK = new RailingBlock(Block.Settings.create().mapColor(MapColor.WHITE).instrument(NoteBlockInstrument.IRON_XYLOPHONE).requiresTool().strength(5.0F, 6.0F).sounds(BlockSoundGroup.METAL).nonOpaque().solidBlock(Blocks::never).suffocates(Blocks::never).pistonBehavior(PistonBehavior.DESTROY).blockVision(Blocks::never));
	public static final RailingBlock ORANGE_RAILING_BLOCK = new RailingBlock(Block.Settings.create().mapColor(MapColor.ORANGE).instrument(NoteBlockInstrument.IRON_XYLOPHONE).requiresTool().strength(5.0F, 6.0F).sounds(BlockSoundGroup.METAL).nonOpaque().solidBlock(Blocks::never).suffocates(Blocks::never).pistonBehavior(PistonBehavior.DESTROY).blockVision(Blocks::never));
	public static final RailingBlock MAGENTA_RAILING_BLOCK = new RailingBlock(Block.Settings.create().mapColor(MapColor.MAGENTA).instrument(NoteBlockInstrument.IRON_XYLOPHONE).requiresTool().strength(5.0F, 6.0F).sounds(BlockSoundGroup.METAL).nonOpaque().solidBlock(Blocks::never).suffocates(Blocks::never).pistonBehavior(PistonBehavior.DESTROY).blockVision(Blocks::never));
	public static final RailingBlock LIGHT_BLUE_RAILING_BLOCK = new RailingBlock(Block.Settings.create().mapColor(MapColor.ORANGE).instrument(NoteBlockInstrument.IRON_XYLOPHONE).requiresTool().strength(5.0F, 6.0F).sounds(BlockSoundGroup.METAL).nonOpaque().solidBlock(Blocks::never).suffocates(Blocks::never).pistonBehavior(PistonBehavior.DESTROY).blockVision(Blocks::never));
	public static final RailingBlock YELLOW_RAILING_BLOCK = new RailingBlock(Block.Settings.create().mapColor(MapColor.YELLOW).instrument(NoteBlockInstrument.IRON_XYLOPHONE).requiresTool().strength(5.0F, 6.0F).sounds(BlockSoundGroup.METAL).nonOpaque().solidBlock(Blocks::never).suffocates(Blocks::never).pistonBehavior(PistonBehavior.DESTROY).blockVision(Blocks::never));
	public static final RailingBlock LIME_RAILING_BLOCK = new RailingBlock(Block.Settings.create().mapColor(MapColor.LIME).instrument(NoteBlockInstrument.IRON_XYLOPHONE).requiresTool().strength(5.0F, 6.0F).sounds(BlockSoundGroup.METAL).nonOpaque().solidBlock(Blocks::never).suffocates(Blocks::never).pistonBehavior(PistonBehavior.DESTROY).blockVision(Blocks::never));
	public static final RailingBlock PINK_RAILING_BLOCK = new RailingBlock(Block.Settings.create().mapColor(MapColor.PINK).instrument(NoteBlockInstrument.IRON_XYLOPHONE).requiresTool().strength(5.0F, 6.0F).sounds(BlockSoundGroup.METAL).nonOpaque().solidBlock(Blocks::never).suffocates(Blocks::never).pistonBehavior(PistonBehavior.DESTROY).blockVision(Blocks::never));
	public static final RailingBlock GRAY_RAILING_BLOCK = new RailingBlock(Block.Settings.create().mapColor(MapColor.GRAY).instrument(NoteBlockInstrument.IRON_XYLOPHONE).requiresTool().strength(5.0F, 6.0F).sounds(BlockSoundGroup.METAL).nonOpaque().solidBlock(Blocks::never).suffocates(Blocks::never).pistonBehavior(PistonBehavior.DESTROY).blockVision(Blocks::never));
	public static final RailingBlock LIGHT_GRAY_RAILING_BLOCK = new RailingBlock(Block.Settings.create().mapColor(MapColor.LIGHT_GRAY).instrument(NoteBlockInstrument.IRON_XYLOPHONE).requiresTool().strength(5.0F, 6.0F).sounds(BlockSoundGroup.METAL).nonOpaque().solidBlock(Blocks::never).suffocates(Blocks::never).pistonBehavior(PistonBehavior.DESTROY).blockVision(Blocks::never));
	public static final RailingBlock CYAN_RAILING_BLOCK = new RailingBlock(Block.Settings.create().mapColor(MapColor.CYAN).instrument(NoteBlockInstrument.IRON_XYLOPHONE).requiresTool().strength(5.0F, 6.0F).sounds(BlockSoundGroup.METAL).nonOpaque().solidBlock(Blocks::never).suffocates(Blocks::never).pistonBehavior(PistonBehavior.DESTROY).blockVision(Blocks::never));
	public static final RailingBlock PURPLE_RAILING_BLOCK = new RailingBlock(Block.Settings.create().mapColor(MapColor.PURPLE).instrument(NoteBlockInstrument.IRON_XYLOPHONE).requiresTool().strength(5.0F, 6.0F).sounds(BlockSoundGroup.METAL).nonOpaque().solidBlock(Blocks::never).suffocates(Blocks::never).pistonBehavior(PistonBehavior.DESTROY).blockVision(Blocks::never));
	public static final RailingBlock BLUE_RAILING_BLOCK = new RailingBlock(Block.Settings.create().mapColor(MapColor.BROWN).instrument(NoteBlockInstrument.IRON_XYLOPHONE).requiresTool().strength(5.0F, 6.0F).sounds(BlockSoundGroup.METAL).nonOpaque().solidBlock(Blocks::never).suffocates(Blocks::never).pistonBehavior(PistonBehavior.DESTROY).blockVision(Blocks::never));
	public static final RailingBlock BROWN_RAILING_BLOCK = new RailingBlock(Block.Settings.create().mapColor(MapColor.ORANGE).instrument(NoteBlockInstrument.IRON_XYLOPHONE).requiresTool().strength(5.0F, 6.0F).sounds(BlockSoundGroup.METAL).nonOpaque().solidBlock(Blocks::never).suffocates(Blocks::never).pistonBehavior(PistonBehavior.DESTROY).blockVision(Blocks::never));
	public static final RailingBlock GREEN_RAILING_BLOCK = new RailingBlock(Block.Settings.create().mapColor(MapColor.GREEN).instrument(NoteBlockInstrument.IRON_XYLOPHONE).requiresTool().strength(5.0F, 6.0F).sounds(BlockSoundGroup.METAL).nonOpaque().solidBlock(Blocks::never).suffocates(Blocks::never).pistonBehavior(PistonBehavior.DESTROY).blockVision(Blocks::never));
	public static final RailingBlock RED_RAILING_BLOCK = new RailingBlock(Block.Settings.create().mapColor(MapColor.RED).instrument(NoteBlockInstrument.IRON_XYLOPHONE).requiresTool().strength(5.0F, 6.0F).sounds(BlockSoundGroup.METAL).nonOpaque().solidBlock(Blocks::never).suffocates(Blocks::never).pistonBehavior(PistonBehavior.DESTROY).blockVision(Blocks::never));
	public static final RailingBlock BLACK_RAILING_BLOCK = new RailingBlock(Block.Settings.create().mapColor(MapColor.BLACK).instrument(NoteBlockInstrument.IRON_XYLOPHONE).requiresTool().strength(5.0F, 6.0F).sounds(BlockSoundGroup.METAL).nonOpaque().solidBlock(Blocks::never).suffocates(Blocks::never).pistonBehavior(PistonBehavior.DESTROY).blockVision(Blocks::never));
